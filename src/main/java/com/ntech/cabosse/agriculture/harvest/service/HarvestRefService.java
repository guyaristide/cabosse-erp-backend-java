...
/** Génère les références séquentielles {@code HV-YYYY-NNNN}. */
@ApplicationScoped
public class HarvestRefService {

    private static final String COLLECTION = "counters";
    private static final String KEY_PREFIX = "harvest:";
    ...
    public String next() {
        ...
        return String.format("HV-%d-%04d", year, seq);
    }
}
