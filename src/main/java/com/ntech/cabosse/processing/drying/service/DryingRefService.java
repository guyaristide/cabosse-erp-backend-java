...
/** Génère les références séquentielles {@code SEC-YYYY-NNNN}. */
@ApplicationScoped
public class DryingRefService {

    private static final String COLLECTION = "counters";
    private static final String KEY_PREFIX = "drying:";
    ...
    public String next() {
        ...
        return String.format("SEC-%d-%04d", year, seq);
    }
}
