...
/** Références séquentielles {@code REG-YYYY-NNNN} des règlements fournisseurs. */
@ApplicationScoped
public class ProducerPaymentRefService {

    private static final String COLLECTION = "counters";
    private static final String KEY_PREFIX = "producer_payment:";
