...
final class ManufacturingOrderExportColumns {
    ...
    static List<ExportColumn<ProductionOrderResponseDto>> all() {
        return List.of(
                ...
                ExportColumn.of(Messages.msg("m.imp-h-cout-matiere"),     ProductionOrderResponseDto::totalMaterialCost),
                ExportColumn.of(Messages.msg("m.imp-h-cmup-pf"),          ProductionOrderResponseDto::cmupAtCompletion),
