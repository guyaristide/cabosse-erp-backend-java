...
/** Références séquentielles {@code CRE-YYYY-NNNN} des crédits aux membres. */
@ApplicationScoped
public class MemberCreditRefService {

    private static final String COLLECTION = "counters";
    private static final String KEY_PREFIX = "member_credit:";
