...
public enum AuditEventType {
    ...
    COLLECTOR_ADVANCE_APPROVED,
    COLLECTOR_ADVANCE_REJECTED,
    COLLECTOR_ADVANCE_DISBURSED,
    COLLECTOR_ADVANCE_DELIVERY,
    COLLECTOR_ADVANCE_CLOSED,
    COLLECTOR_ADVANCE_ATTACHMENT,
    PRODUCER_PURCHASE_CREATED,
    PRODUCER_PURCHASE_CANCELLED,
    PRODUCER_PAYMENT_CREATED,
    COMMODITY_SALE_CREATED,
    ...
    // === Stocks (M5) ===
    TREASURY_TRANSFER_SENT,
    TREASURY_TRANSFER_RECEIVED,
    TREASURY_TRANSFER_CANCELLED,
    CASH_COUNT_RECORDED,

    MEMBER_CREDIT_REQUESTED,
    MEMBER_CREDIT_APPROVED,
    MEMBER_CREDIT_REJECTED,
    MEMBER_CREDIT_DISBURSED,
    MEMBER_CREDIT_IMPUTED,
    MEMBER_CREDIT_CANCELLED,
    MEMBER_CREDIT_ATTACHMENT,
    ...
    public AuditCategory category() {
        return switch (this) {
            ...
            case TICKET_OPENED, TICKET_ASSIGNED, TICKET_PRIORITY_CHANGED, TICKET_STATUS_CHANGED,
            ...
            case COLLECTOR_ADVANCE_CREATED, COLLECTOR_ADVANCE_APPROVED,
                 COLLECTOR_ADVANCE_REJECTED, COLLECTOR_ADVANCE_DISBURSED,
                 COLLECTOR_ADVANCE_DELIVERY,
            ...
            case TREASURY_TRANSFER_SENT, TREASURY_TRANSFER_RECEIVED,
                 TREASURY_TRANSFER_CANCELLED, CASH_COUNT_RECORDED -> AuditCategory.OPERATIONS;
            case MEMBER_CREDIT_REQUESTED, MEMBER_CREDIT_APPROVED, MEMBER_CREDIT_REJECTED,
                 MEMBER_CREDIT_DISBURSED, MEMBER_CREDIT_IMPUTED,
                 MEMBER_CREDIT_CANCELLED, MEMBER_CREDIT_ATTACHMENT -> AuditCategory.OPERATIONS;
