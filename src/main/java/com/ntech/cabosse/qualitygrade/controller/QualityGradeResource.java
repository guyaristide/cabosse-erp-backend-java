...
import com.ntech.cabosse.qualitygrade.service.QualityGradeService;
...
@Tag(name = "Grades de qualité", description = "Référentiel des grades de qualité du tenant")
...
public class QualityGradeResource {
    ...
    @GET
    @Operation(summary = "Liste des grades de qualité du tenant")
