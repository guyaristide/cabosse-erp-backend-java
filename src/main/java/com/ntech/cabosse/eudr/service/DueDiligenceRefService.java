...
/** Génère les références séquentielles {@code DDR-YYYY-NNNN}. */
@ApplicationScoped
public class DueDiligenceRefService {

    private static final String COLLECTION = "counters";
    private static final String KEY_PREFIX = "ddr:";
    ...
    public String next() {
        ...
        return String.format("DDR-%d-%04d", year, seq);
    }
}
