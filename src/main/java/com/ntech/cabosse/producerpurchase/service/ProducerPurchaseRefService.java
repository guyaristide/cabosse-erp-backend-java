...
/** Génère les références séquentielles {@code ACP-YYYY-NNNN} des reçus d'achat producteur (NEG-01). */
@ApplicationScoped
public class ProducerPurchaseRefService {

    private static final String COLLECTION = "counters";
    private static final String KEY_PREFIX = "producer_purchase:";
    ...
    public String next() {
        ...
        return String.format("ACP-%d-%04d", year, seq);
    }
}
